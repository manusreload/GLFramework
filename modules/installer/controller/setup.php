...
class setup extends Controller
{
    ...
    public function run()
    {
        ...
        if(isset($this->mainConfig['installer']['autogenerated_path']))
        {
            $file = $this->mainConfig['installer']['autogenerated_path'];
        }
        $this->configManager = new ConfigurationManager($file);
